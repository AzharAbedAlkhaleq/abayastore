                        ...
                        <div class="row text-right pt-5 mt-3">
                            <div class="col-md-3 col-sm-12   aa ">
                                <div class="phone d-flex mb-3">
                                    <input type="text" name="phone" id="number" placeholder="ادخل الهاتف" class="">

                                    <a href="#" class="btn btn-lg px-2"  onclick="phoneSendAuth();"> ارسال</a>

                                </div>

                                <div class="justify-content-between">
                                    <input type="text" name="otp" id="successRegsiter" placeholder="ادخل رمز التحقق" class="">
                                    <a href="#" class="mt-5 px-2"  onclick="codeverify();"> اعادة ارسال</a>
...
<div id="recaptcha-container">
    <form method="POST" accept="{{route('sendSMSCode')}}">
        @csrf
        <input type="text" name="phone" id="number" placeholder="ادخل الهاتف" class="">
